    ...
    <div className="w-full h-full flex items-center justify-center px-6 md:px-12">
      <div className="max-w-4xl w-full">
        ...
        >
          ...
          <motion.a
            href={`mailto:${email}`}
            className={`inline-flex items-center gap-2 ${accentTextClass} text-xl md:text-2xl font-bold ${accentHoverClass} transition-colors group`}
