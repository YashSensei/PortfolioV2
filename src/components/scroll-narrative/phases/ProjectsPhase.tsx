 ...
 */
export default function ProjectsPhase({ accentColor, projects, sectionIndex = 3 }: ProjectsPhaseProps) {
...
function ProjectCard({
  ...
  return (
    <div className={`bg-[#18181b] p-6 md:p-8 rounded-2xl border border-gray-800 hover:border-gray-700 transition-all`}>
      {/* Project header */}
